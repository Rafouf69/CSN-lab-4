...
for (language in source$language) {
  ...
  s_vec = sapply(list(model_0_s, nlm_1, nlm_2, nlm_3, nlm_4, nlm_1_plus, nlm_4_plus), compute_s)
  AIC_vec = sapply(list(model_0_AIC, nlm_1, nlm_2, nlm_3, nlm_4, nlm_1_plus, nlm_4_plus), AIC)
